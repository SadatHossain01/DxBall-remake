...
typedef enum _PowerupType{
	ExtraLife = 0, WidePaddle, FasterBall, ThruBall, SlowerBall, ShrinkBall, ShrinkPaddle, SuperShrinkPaddle, MegaBall, Death, FallingBricks
} PowerupType;
typedef enum _Page{
	Gameplay, MainMenu, Credits, Play_New_Continue, Instructions, Welcome, EnterYourName, HighScores, Continue_Save_Menu_ExitGame
} Page;
